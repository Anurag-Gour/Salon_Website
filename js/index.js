...
let servicesobj = {
  spa: {
    Pedicure: {
      ...
      price: 35,
      description:
        "Treat your feet to a pampering pedicure experience. Includes exfoliation, nail shaping, cuticle care, callus removal, massage, and polish application.",
    },
    NailArt: {
      ...
      price: 20,
      description:
        "Express yourself with creative nail art designs. Choose from a variety of colors, patterns, and embellishments to adorn your nails.",
    },
    BodyWrap: {
      ...
      price: 60,
      description:
        "Indulge in a detoxifying body wrap to firm and tone your skin. Helps to eliminate toxins, reduce cellulite, and improve skin texture.",
    },
    MakeUP: {
      ...
      price: 40,
      description:
        "Enhance your natural beauty with our premium cosmetics service. Professional makeup application for any occasion, ensuring a flawless finish.",
    },
    Reflexology: {
      ...
      price: 55,
      description:
        "Restore balance and harmony to your body with our reflexology treatment. Pressure is applied to specific points on the feet to stimulate healing and relaxation throughout the body.",
    },
  },
  ...
  hair: {
    ...
    HairColoring: {
      ...
      price: 80,
      description:
        "Hair coloring service using high-quality products for vibrant results.",
    },
    HairStyling: {
      ...
      price: 60,
      description:
        "Hair styling for special occasions to complement your look.",
    },
    HairTreatment: {
      ...
      price: 70,
      description:
        "Hair treatment to nourish and repair damaged hair for improved health and shine.",
    },
    HairExtensions: {
      ...
      price: 100,
      description:
        "Hair extensions for added length and volume for a glamorous hairstyle.",
    },
  },
  facial: {
    DeepCleansing: {
    ...
    AntiAging: {
      ...
      price: 90,
      description:
        "Anti-aging facial to reduce wrinkles and improve skin elasticity.",
    },
    Hydrating: {
      ...
      price: 70,
      description:
        "Hydrating facial to replenish moisture and restore skin's natural glow.",
    },
    Brightening: {
      ...
      price: 75,
      description:
        "Brightening facial to even out skin tone and reduce dark spots.",
    },
    AcneTreatment: {
      ...
      price: 85,
      description:
        "Acne treatment facial to target and prevent breakouts for clear skin.",
    },
  },
  ...
  waxing: {
    EyeBrows: {
      ...
      price: 15,
      description:
        "Eyebrow waxing to shape and define eyebrows for a polished look.",
    },
    Legs: {
      ...
      price: 50,
      description:
        "Leg waxing to remove unwanted hair for smooth and silky legs.",
    },
    Bikini: {
      ...
      price: 40,
      description:
        "Bikini waxing for tidy and groomed bikini area for confident beach days.",
    },
    Brazilian: {
    ...
    FullBody: {
      ...
      price: 200,
      description:
        "Full body waxing for complete hair removal and silky smooth skin.",
    },
  },
  massage: {
    SwedishMassage: {
      ...
      price: 60,
      description:
        "Swedish massage for relaxation and stress relief with long, flowing strokes.",
    },
    DeepTissueMassage: {
      ...
      price: 70,
      description:
        "Deep tissue massage to target knots and tension in muscles for pain relief.",
    },
    HotStoneMassage: {
      ...
      price: 80,
      description:
        "Hot stone massage for deep relaxation and muscle relaxation with heated stones.",
    },
    AromatherapyMassage: {
      ...
      price: 75,
      description:
        "Aromatherapy massage using essential oils to promote relaxation and wellbeing.",
    },
    SportsMassage: {
      ...
      price: 85,
      description:
        "Sports massage to improve athletic performance and prevent injuries with targeted techniques.",
    },
  },
};
